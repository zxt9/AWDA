...
class BaseDataSet(Dataset):
    def __init__(self, data_dir, split, base_size=None, augment='weak',
                val=False, crop_size=None, scale=False, flip=False):
        self.num_classes = 2
    ...
    def _weak_augmentation(self, image_A, image_B, label):
        ...
        return self.normalize(self.to_tensor(image_A)), \
               self.normalize(self.to_tensor(image_B)), label
    ...
    def _strong_augmentation(self, image_A, image_B, label):
        ...
        return self.normalize(self.to_tensor(image_WA)), \
               self.normalize(self.to_tensor(image_WB)), \
               self.normalize(self.to_tensor(image_SA)), \
               self.normalize(self.to_tensor(image_SB)), label
